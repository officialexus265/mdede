 ...
 *
 * On any platform that hosts many apps on sibling subdomains of one parent
 * domain, those apps are "same-site" to each other but MUTUALLY UNTRUSTED, and a `SameSite=Lax` session cookie IS sent on same-site
